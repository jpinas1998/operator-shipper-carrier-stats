function drawCarrierStatsByVehicularConf() {

    const source_data = JSON.parse(window.stats_by_vehicular_conf);
    ...
    const ctx = document.getElementById('carrier-stats-by-vehicular-conf-chart-container').getContext('2d');
    window.myBar = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Estadísticas de la configuración vehicular'
                }
            },
        }
    });
