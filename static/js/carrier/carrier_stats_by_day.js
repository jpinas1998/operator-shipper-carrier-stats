function drawCarrierStatsByDay() {

    const source_data = JSON.parse(window.stats_by_day);
    ...
    const ctx = document.getElementById('carrier-stats-by-date-chart-container').getContext('2d');
