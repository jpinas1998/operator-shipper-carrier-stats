function drawCarrierStatsByLicence() {

    const source_data = JSON.parse(window.stats_by_license);
    ...
    const ctx = document.getElementById('carrier-stats-by-licence-chart-container').getContext('2d');
    window.myBar = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Estadísticas de los vehículos'
                }
            },
        }
    });
