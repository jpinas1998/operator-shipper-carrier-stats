function drawCarrierDocStatus() {

    const data = JSON.parse(window.carrier_doc_status);
    ...
    const ctx = document.getElementById("carrier-docs-status-chart-container").getContext('2d');
