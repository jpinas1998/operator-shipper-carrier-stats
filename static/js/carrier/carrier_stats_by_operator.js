function drawCarrierStatsByOperator() {

    const source_data = JSON.parse(window.stats_by_operator);
    ...
    const ctx = document.getElementById('carrier-stats-by-operator-chart-container').getContext('2d');
    window.myBar = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Estadísticas de los operadores'
                }
            },
        }
    });
