function drawShipperStatsByVehicularConf() {

    const source_data = JSON.parse(window.shipper_stats_by_vehicular_conf);
    ...
    const ctx = document.getElementById('shipper-stats-by-vehicular-conf-chart-container').getContext('2d');
    window.myBar = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Estadísticas por configuración vehicular'
                }
            },
        }
    });
